...
# Text box
T = tk.Text(top, font=('calibre',15,'normal'), fg = "red", height=1) #UPDATE FONT SIZE IF NECESSARY
T.place(relx = 0.3, rely = 0.1) # PLACE THE FILENAME BOX

# Counter
counter = tk.Text(top, font=('calibre',15,'normal'), fg = "red" , height=1) #UPDATE FONT SIZE IF NECESSARY
counter.place(anchor=tk.NW) # PLACE THE FILENAME BOX

# Entry box 
w = tk.Entry(top, takefocus=True, font=('calibre',15,'normal')) #UPDATE FONT SIZE IF NECESSARY
